...
public static double adapt4(										// recursiv funktion, der kalder på sig selv igen og igen indtil den når limit/eller når et accurat resultat. 
	...
	double f2=NaN, double f3=NaN)									// genbruger punkterne f2 og f3 fra tidligere, og hvis de ikke der er punkt (dvs. NaN), så har vi defineret, hvordan de skal regnes ud. 
{
